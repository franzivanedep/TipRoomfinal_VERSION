...
export function Dtoolbox() {
  ...
  const addItemToToolbox = (item) => {
    setToolboxItems([...toolboxItems, item]);
    console.log(`Added ${item.name} to toolbox.`);
 };
    ...
    <div className="hidden border-r bg-gray-100/40 lg:block dark:bg-gray-800/40">
      ...
      <div className="flex flex-col">
        <header
          ...
          <Toolboxicon style={{ marginLeft: '-10px' }} />
        ...
        <ToolboxCompile addToToolbox={addItemToToolbox} toolboxItems={toolboxItems} />
        </main>
      </div>
    </div>)
  );
